...
class _SmaCrossStrategy:
    ...
    def update_buy_error_list(self):
        ...
        x = self.indicators.current_price() - self.state.current_min
        if x < 0:
            print(x)
        self.state.buy_daily_error_list.append(x)
    ...
    def update_sell_error_list(self):
        ...
        x = self.state.current_max - self.indicators.current_price()
        if x < 0:
            print(x)
        self.state.sell_daily_error_list.append(x)
