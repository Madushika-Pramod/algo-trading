...
class TestSmaCrossStrategy(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.state.price_of_last_purchase = 600
        ...
        self.strategy = _SmaCrossStrategy(self.indicators, self.config, self.state, self.trader)
    ...
    def test_execute_sell_orders(self):
        ...
        self.assertEqual(self.state.price_of_last_sale, 60.0)

    def test_need_to_cancel_buy_order(self):
        self.state.trade_active = False
        self.state.pending_order = {'hwm': '550'}
        self.indicators.current_price = MagicMock(return_value=500)
        result = self.strategy._need_to_cancel_buy_order()
        self.assertTrue(result)
...
#
    ...
    def test_conditions_met_for_buy(self):
        self.state.trade_active = False
        self.assertTrue(self.strategy._conditions_met_for_buy())
